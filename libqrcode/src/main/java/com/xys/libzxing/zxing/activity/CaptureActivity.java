...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        ImageView iv = (ImageView) findViewById(R.id.top_bar_right);
        iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CaptureActivity.this,HelpSaoma.class));
            }
        });
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        ...
        //beepManager.playBeepSoundAndVibrate();//扫码成功后播放警示音

        Intent resultIntent = new Intent();
        resultIntent.setClass(CaptureActivity.this,ResultStudy.class);
